...
echo "   ./test-defender-sql-alerts.sh --host $SQL_MI_FQDN"
echo ""
echo "🧪 Example test commands:"
echo "   # Interactive menu mode"
echo "   ./test-defender-sql-alerts.sh --host $SQL_MI_FQDN --menu"
echo ""
echo "   # Password brute force test"
echo "   ./test-defender-sql-alerts.sh --host $SQL_MI_FQDN --test password-brute"
echo ""
echo "   # Comprehensive brute force testing"
echo "   ./test-defender-sql-alerts.sh --host $SQL_MI_FQDN --test comprehensive-brute"
echo ""
echo "   # Run all security tests"
echo "   ./test-defender-sql-alerts.sh --host $SQL_MI_FQDN --username d4sqlsim --password 'YourPassword' --batch"
